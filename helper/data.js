export const data = [
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/add/{propertyName}'",
        "\n",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/add/{propertyName}/{data}'",
        "\n",
        "   let insert = await fetch(url, {headers: header})",
        "\n",
        "   let json = await insert.json()",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/select/properties'",
        "\n",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/select/{propertyName}'",
        "\n",
        "   let data = await fetch(url, {headers: header})",
        "\n",
        "   let json = await data.json()",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/select/{propertyName}/{data}'",
        "\n",
        "   let data = await fetch(url, {headers: header})",
        "\n",
        "   let json = await data.json()",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/update/{propertyName}/{oldData}/{newData}'",
        "\n",
    ...
    [
        ...
        "   }",
        "\n",
        "   let url = 'http://localhost:3000/api/delete/{propertyName}/{data}'",
        "\n",
